                ...
                <div class="col" style="--w-md: 7">
                    ...
                    <div class="payment__items">
                        <!-- <div class="payment__item checked d-flex align-center">
                            <input class="payment__radio" type="radio" name="order_type" id="payment_default" value="1"
                                checked />
                        ...
                        <div class="payment__item d-flex align-center">
                            <input class="payment__radio" type="radio" name="order_type" id="payment_momo_qr"
                                value="2" />
                            <img class="payment__icon" src="./assets/images/payment/qrcode.png" alt="QR CODE"
                                style="width: 62px;">
                        ...
                        <div class="payment__item d-flex align-center"> 
                            <input class="payment__radio" type="radio" name="order_type" id="payment_momo_atm"
                                value="3" />
                            <img class="payment__icon" src="./assets/images/payment/momo.png" alt="QR CODE"
                                style="width: 62px;">
                        ...
                        <div class="payment__item d-flex align-center">
                            ...
                            <img class="payment__icon" src="./assets/images/payment/vnpay.png" alt="QR CODE"
                                style="width: 62px;">
